...
/**
 * MyWindow1 - Review: create a Window class that extends JFrame,
...
public class MyWindow1 extends JFrame {
	...
	public MyWindow1() {
		setTitle("APC 390 Lesson 10 - GUI - MyWindow1");
...
/**
 * QuitButtonListener - class used to respond to button clicks of the Quit JButton
