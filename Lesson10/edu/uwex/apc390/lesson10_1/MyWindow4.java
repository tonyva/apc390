...
/**
 * MyWindow4 - Review: create a Window class that extends JFrame,
 ...
 *          - Refactor MyWindow3 to have an anonymous Listener class
...
public class MyWindow4 extends JFrame {
	...
	public MyWindow4() {
		setTitle("APC 390 Lesson 10 - GUI - MyWindow4");
	...
	private void addComponents() {
		...
		quit.addActionListener(
			/*
			 * Anonymous class used inside the addComponents method in MyWindow4 
